...
public class MessageBuilder {
    ...
    private final Map<String, Object> messageData = new HashMap<>();

    public MessageBuilder(final ResponseBuilder response) {
    ...
    public MessageBuilder token(final String token) {
